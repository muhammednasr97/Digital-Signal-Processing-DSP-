...
xlim = [0:1:length(handles.audio_data)-1]/handles.Fs;
 subplot(2,1,1);
 plot(xlim,handles.audio_data);
 xlim1 = [0:1:length(handles.yT)-1]/handles.Fs;
 subplot(2,1,2);
 plot(xlim1,handles.yT);
 play(player);
...
set(handles.text21, 'String','0'); % n for edit box
...
handles.n1 = set(handles.slider1,'value',0);
handles.n2 = set(handles.slider2,'value',0);
handles.n3 = set(handles.slider3,'value',0);
handles.n4 = set(handles.slider4,'value',0);
handles.n5 = set(handles.slider5,'value',0);
handles.n6 = set(handles.slider6,'value',0);
handles.n7= set(handles.slider7,'value',0);
handles.n8 = set(handles.slider8,'value',0);
handles.n9= set(handles.slider9,'value',0);
handles.n10 = set(handles.slider10,'value',0);
